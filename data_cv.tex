...
% NOTE: pdfpagelabels=false needed fpr the warning : Package hyperref Warning: Rerun to get /PageLabels entry
...
\definecolor{mylightblue}{HTML}{736DEC}
...
\begin{center}  
\vspace{-0.8 cm}
50 years  old \ding{113} French nationality \ding{113} Three children \ding{113} Swiss resident permit C 
...
\begin{minipage}{14cm}
\begin{center}
\large\textit{/home/gabx\#} export POSITION=DATA SCIENTIST
\end{center}
\end{minipage}
} 
